...
|Description|Link|Name|Size|Version|
|----|----|----|----|----|
|A Sample project file containing few seconds of Color Bar HLG|[Sample_Color_Bar_HLG.drp](https://raw.githubusercontent.com/thethales/File-Examples/main//file-examples/DRP/Sample_Color_Bar_HLG.drp)|Sample_Color_Bar_HLG.drp|27.2 KB|17.1|
...
|Google Picasa sample backup configuration file|[googlepicasa.picasa.ini](https://raw.githubusercontent.com/thethales/File-Examples/main//file-examples/INI/googlepicasa.picasa.ini)|googlepicasa.picasa.ini|273.0 B||
...
```.mta``` files are index files created by Samsung Allshare and [Samsung Kies](https://en.wikipedia.org/wiki/Samsung_Kies) to enable navigation of video chapters. The file is XML based and contains thumbnails in base64 format

|Description|Link|Name|Size|Version|
|----|----|----|----|----|
|An ```.mta``` sample built from a  ```.avi``` video file by Samsung Kies. Samsung video metadata file generated by SMVideoEngine (Samsung Metadata Video Engine) v1.0, June 2009|[MOV03439.AVI.mta](https://raw.githubusercontent.com/thethales/File-Examples/main//file-examples/MTA/MOV03439.AVI.mta)|MOV03439.AVI.mta|17.57 KB|1.0|
